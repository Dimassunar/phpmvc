            ...
            <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#modol">
                    Tambah Guru
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <input type="text" class="form-control"  id="pelajaran" name="pelajaran" autocomplete="off">
                                </div>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#moll<?=$blog['id']?>">
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="form-group">
                                <label for="pelajaran" >Pelajaran</label>
                                <input type="text" class="form-control" value="<?= $blog['pelajaran']?>" id="pelajaran" name="pelajaran" readonly>
                                </div>
                        ...
                        <button type="button" class="btn btn-success mr-2" data-toggle="modal" data-target="#exampleModal<?=$blog['id']?>">
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="form-group">
                                <label for="pelajaran" >Pelajaran</label>
                                <input type="text" class="form-control" value="<?= $blog['pelajaran']?>" id="pelajaran" name="pelajaran" autocomplete="off">
                                </div>
